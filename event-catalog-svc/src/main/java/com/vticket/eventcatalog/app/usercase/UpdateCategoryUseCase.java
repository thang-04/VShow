...
public class UpdateCategoryUseCase {
    ...
    public CategoryResponse updateCategory(long cateId, UpdateCategoryRequest updateCategoryRequest) {
        ...
        try {
            ...
            log.info("{}|Updated category success for id {}. Time taken: {} ms", prefix, cateId,
